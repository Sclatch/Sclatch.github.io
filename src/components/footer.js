...
export default function Footer (){
    return (
        <footer id="contact" class="p-4 rounded-t-2xl bg-white dark:bg-gray-900">
            <div class="container py-8 md:px-4 md:flex md:justify-between mx-auto">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-8" alt="FlowBite Logo"/>
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Let's work together!</span>
                    </a>
                </div>
